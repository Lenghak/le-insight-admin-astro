...
export function ProgressBar({
  ...
  return (
    <div
      ref={ref}
      className={cn("h-full rounded-lg bg-accent shadow-md", className)}
      {...props}
    >
      <div
        className="h-full rounded-lg bg-primary duration-100"
        style={{
          width: progressWidth,
        }}
      />
...
export function FailBar({
  ...
  return (
    <div
      className={cn(
        "h-full rounded-lg border bg-destructive text-center text-xs font-bold uppercase leading-tight tracking-widest text-destructive-foreground shadow-md",
        className,
      )}
      {...props}
    />
