					...
					>
						<div className="flex w-full items-start justify-between gap-4">
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel className="font-bold" htmlFor="firstname-field">
											First Name
										</FormLabel>
										<FormControl>
											<Input
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel className="font-bold" htmlFor="lastname-field">
											Last Name
										</FormLabel>
										<FormControl>
											<Input
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel className="font-bold" htmlFor="email-field">
										Email
									</FormLabel>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel className="font-bold" htmlFor="password-field">
										Password
									</FormLabel>
									<FormControl>
