...
import patchEditArticlesAPI from "@articles/services/patch-edit-articles-api";
import type { UpdateArticleRequestType } from "@articles/types/articles-edit-type";
...
export default function useEditArticlesService() {
	const instance = usePrivateQueryInstance();
	const queryClient = useStore($queryClient);

	return useMutation(
		{
			mutationKey: [...articleKeys.detail("edit"), instance],
			mutationFn: async ({
				id,
				data,
			}: {
			...
			}) => await patchEditArticlesAPI(id, data),
