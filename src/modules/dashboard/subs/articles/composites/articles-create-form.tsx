				...
				<Tooltip>
					<TooltipTrigger asChild>
						<DrawerTrigger asChild ref={ref}>
							{trigger ?? (
								<Button className="gap-4 size-9" size={"icon"}>
									<CheckIcon className="size-4" strokeWidth={3} />
									<span className="font-bold sr-only">Done</span>
								</Button>
							)}
						</DrawerTrigger>
					</TooltipTrigger>
						...
						<div className="flex h-full w-full flex-col gap-4">
							...
							<Alert className="mt-6 items-center border-none bg-transparent pr-8">
								...
								<AlertTitle className="font-serif text-sm italic">
									...
									limited.{" "}
									<Button variant={"link"} className="size-fit p-0 px-1 italic">
										Learn more
									</Button>
								</AlertTitle>
							</Alert>
								...
								<div className="flex w-full items-center justify-between">
									<div className="flex items-center justify-center gap-4">
										...
										<Button
											...
											className={cn(
												"gap-0 px-8 font-bold transition-all font-sans",
